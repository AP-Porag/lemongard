...
const faqs = [
    ...
    },
    {
        ...
        a: "Every user contributes their records to a shared, searchable database. This creates a valuable collective knowledge base for the service industry. You can search and search all records, but your specific business data remains secure and only you can modify your entries.",
    },
    {
