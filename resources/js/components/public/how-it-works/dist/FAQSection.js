...
var FAQSection = function () {
    return (React.createElement("section", { className: "section-padding" },
        React.createElement("div", { className: "bg-[#f8fafc] p-8 lg:p-16" },
            React.createElement(framer_motion_1.motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.6 }, className: "text-center mb-12" },
                React.createElement("div", { className: "flex items-center justify-center gap-2 mb-4" },
                    ...
                    React.createElement("span", { className: "text-sm font-medium text-yellow-600 uppercase tracking-wide" }, "Frequently Asked Questions")),
                React.createElement("h2", { className: "text-3xl md:text-4xl font-bold text-navy-600" }, "Got Questions? We've Got Answers"),
                React.createElement("p", { className: "text-lg text-muted-foreground mt-4" }, "Everything you need to know about how LemonGard works")),
            React.createElement(framer_motion_1.motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.6, delay: 0.2 }, className: "max-w-3xl mx-auto" },
                React.createElement(accordion_1.Accordion, { type: "single", collapsible: true, className: "space-y-2" }, faqs.map(function (faq, i) { return (React.createElement(accordion_1.AccordionItem, { key: i, value: "faq-" + i, className: "bg-white rounded-lg px-5 border border-gray-200 data-[state=open]:border-yellow-300 transition-colors" },
                    React.createElement(accordion_1.AccordionTrigger, { className: "text-left text-base font-bold text-[#143694] hover:text-yellow-500 hover:no-underline py-5 gap-3" },
                        React.createElement("span", { className: "flex items-center gap-2" },
                            React.createElement(LemonIcon_1.LemonSimple, { className: "w-4 h-4 text-yellow-400 shrink-0" }),
                            faq.q)),
                    React.createElement(accordion_1.AccordionContent, { className: "text-muted-foreground leading-relaxed pb-5" }, faq.a))); }))))));
};
