...
import { Shield, Eye, Lock, Users, Lightbulb, Heart, Zap } from "lucide-react";
...
const values = [
    ...
    { icon: Zap, title: "Efficiency", desc: "Today, LemonGard provides service professionals with practical tools designed to improve organization, support informed decision-making, and help businesses operate more efficiently." },
];
...
const CoreValuesSection = () => (
    <section className="section-container py-10 lg:py-10">
        ...
        >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-black mb-4">The Principles That Guide Us</h2>
