    ...
    <section className="section-container py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
                ...
                <p className="text-muted-foreground mb-6">Access relevant information and available records to support informed business decisions.</p>

                <div className="flex items-baseline gap-2 mb-2">
                    <span className="text-5xl font-bold text-navy-600">$8.99</span>
                    <span className="text-xl text-muted-foreground">/month</span>
                </div>
                <p className="text-sm text-yellow-600 font-medium mb-8">30 days free, then $8.99/month</p>
            ...
            >
                ...
                <div className="flex items-baseline gap-2 mb-2">
                    <span className="text-5xl font-bold text-navy-600">$12.99</span>
                    <span className="text-xl text-muted-foreground">/month</span>
                </div>
                <span className="text-sm bg-green-50 text-green-700 px-3 py-1 rounded-full inline-block mb-2">Best Value - Full Features</span>
                <p className="text-sm text-yellow-600 font-medium mb-8">30 days free, then $12.99/month</p>
