...
const faqs = [
    ...
    { q: "What's the difference between View Only and Full Access?", a: "View Only ($8.99/month) provides access to search and review available information within the platform.       07      Full Access ($12.99/month) includes all View Only features, plus the ability to add and manage records you create." },
