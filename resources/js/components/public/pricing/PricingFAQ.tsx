...
const faqs = [
  ...
  { q: "What's the difference between View Only and Full Access?", a: "View Only ($14.99/month) lets you search and view all records in the shared database—ideal for research and analysis.       07       Full Access ($19.99/month) includes everything in View Only, plus the ability to add, edit, and delete your own records—ideal for active professionals who want to contribute to the database." },
