 ...
 */
export const LemonSlice = ({ className = "w-6 h-6", opacity = 1 }: LemonIconProps) => (
  <svg
    viewBox="0 0 100 100"
    className={className}
    style={{ opacity }}
  ...
  >
    {/* Outer rind */}
    <circle cx="50" cy="50" r="45" fill="#FCD34D" stroke="#FBBF24" strokeWidth="2"/>
    {/* Inner pulp segments */}
    ...
    <circle cx="50" cy="50" r="8" fill="none" stroke="#FBBF24" strokeWidth="1"/>
    {/* Seeds */}
 ...
 */
export const LemonWhole = ({ className = "w-6 h-6", opacity = 1 }: LemonIconProps) => (
  <svg
    viewBox="0 0 100 100"
    className={className}
    style={{ opacity }}
  ...
  >
    ...
    {/* Stem end (top) */}
    <path d="M 50 20 Q 48 25 50 30 Q 52 25 50 20 Z" fill="#84CC16" opacity="0.8"/>
    ...
    {/* Outline */}
    <ellipse cx="50" cy="55" rx="30" ry="35" fill="none" stroke="#FBBF24" strokeWidth="2"/>
  </svg>
);
 ...
 */
export const LemonSimple = ({ className = "w-6 h-6", opacity = 1 }: LemonIconProps) => (
  <svg
    viewBox="0 0 24 24"
    className={className}
    style={{ opacity }}
 ...
 */
export const LemonHalf = ({ className = "w-6 h-6", opacity = 1 }: LemonIconProps) => (
  <svg
    viewBox="0 0 100 100"
    className={className}
    style={{ opacity }}
  ...
  >
    ...
    <rect x="15" y="35" width="70" height="30" fill="none" stroke="#FBBF24" strokeWidth="2"/>
