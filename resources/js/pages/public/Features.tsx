                        ...
                        >
                            ...
                            <ul className="space-y-5 relative z-10">
                                {[
                                    ...
                                    ["Ownership-Protected Records", "Search all records. Edit and delete only yours. Fair and clear."],
                            ...
                            <div key={g.label}>
                                ...
                                {g.rows.map(([feature, a, b], idx) => (
                                    <div
                                        ...
                                        className={`grid grid-cols-3 border-b border-gray-200 hover:bg-gray-50 transition ${idx % 2 === 0 ? "bg-white" : "bg-gray-50/50"
                                            }`}
                                    >
